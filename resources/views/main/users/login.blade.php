...
<div class="container">
    <main class="form-signin w-100 m-auto">
        <form action="{{ route('user.login') }}"  style="margin-top: 40%;" method="POST">
        @csrf
          <!--<img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">-->
          <h1 class="h3 mb-3 fw-normal">Авторизируйся</h1>
          ...
          <button class="btn btn-success w-100 py-2" type="submit">Подтвердить</button>
        </form>
    </main>
</div>
  <script>login_btn.classList.add('active');</script>
@endsection
